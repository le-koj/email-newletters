...
This project uses **MJML 5** (`mjml@^5.3.0`). The Gulp pipeline calls `await mjml2html(...)` because compilation is async in MJML 5.
...
Ignored: `node_modules/`, `lib/`, `index.html`, `northbridge.html`, `luma.html`
